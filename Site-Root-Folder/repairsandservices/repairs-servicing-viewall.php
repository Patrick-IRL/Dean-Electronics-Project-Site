...
$query_rstservrepall = "SELECT p.*, b.`servorrepname`, c.*, d.* FROM `tblservrep` AS p JOIN `otblservorrep` AS b     ON p.`servrep` = b.`id` JOIN `otblservtype` AS c     ON p.`servtype` = c.`servtype_id` JOIN `otblservstatus` AS d     ON p.`srstatus` = d.`status_id` ORDER BY datesubmitted DESC";
$rstservrepall = mysql_query($query_rstservrepall, $deanelectro) or die(mysql_error());
$row_rstservrepall = mysql_fetch_assoc($rstservrepall);
$totalRows_rstservrepall = mysql_num_rows($rstservrepall);
?>
      ...
      <div id="adminlistview">
        <table width="748" border="1" cellspacing="3" cellpadding="3">
          <tr>
            ...
            <td><?php echo $row_rstservrepall['id']; ?></td>
          </tr>
          <tr>
            <th scope="row">Date Submitted</th>
            <td><?php echo $row_rstservrepall['datesubmitted']; ?></td>
          </tr>
          <tr>
            <th scope="row">Status</th>
            <td><?php echo $row_rstservrepall['status']; ?></td>
          </tr>
          <tr>
            <th scope="row">First Name</th>
            <td><?php echo $row_rstservrepall['srfname']; ?></td>
          </tr>
          <tr>
            <th scope="row">Last Name</th>
            <td><?php echo $row_rstservrepall['srlname']; ?></td>
          </tr>
          <tr>
            <th scope="row">Email</th>
            <td><?php echo $row_rstservrepall['sremail']; ?></td>
          </tr>
          <tr>
            <th scope="row">Phone</th>
            <td><?php echo $row_rstservrepall['srphone']; ?></td>
          </tr>
          <tr>
            <th scope="row">Service or Repair?</th>
            <td><?php echo $row_rstservrepall['servorrepname']; ?></td>
          </tr>
          <tr>
            <th scope="row">Category</th>
            <td><?php echo $row_rstservrepall['servtype']; ?></td>
          </tr>
          <tr>
            <th scope="row">Description of Request</th>
            <td><?php echo $row_rstservrepall['srdesc']; ?></td>
          </tr>
          <tr>
            <th scope="row">Moderate</th>
            <td><a href="repairs-servicing-edit.php?id=<?php echo $row_rstservrepall['id']; ?>">Edit</a> - <a href="repairs-servicing-delete.php?id=<?php echo $row_rstservrepall['id']; ?>">Delete</a></td>
          </tr>
        </table>
      </div>
      <?php } while ($row_rstservrepall = mysql_fetch_assoc($rstservrepall)); ?>
  </div>
...
<?php
mysql_free_result($rstservrepall);
?>
