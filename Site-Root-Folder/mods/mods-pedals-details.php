...
<title>Dean Electronics - Pedal Mods - Product Details</title>
<style type="text/css">
</style>
...
<div id="wrapper" class="clearfix">
  ...
  <div id="productarea">
    <div id="prodtitle"><?php echo $row_rstThePedal['pedalname']; ?></div>
    <div id="prodprice">€<?php echo $row_rstThePedal['price']; ?></div>
    <div id="prodmake"><?php echo $row_rstThePedal['otblbrand_brandname']; ?></div>
    <div id="prodcat"><?php echo $row_rstThePedal['otblcats_catname']; ?></div>
    <div id="prodpic"><img src="<?php echo $row_rstThePedal['prodpic']; ?>" alt="<?php echo $row_rstThePedal['pmpicalt']; ?>" /></div>
    <div id="prodinfo"><?php echo $row_rstThePedal['description']; ?></div>
    <div id="prodlongdesc"><?php echo $row_rstThePedal['longdescription']; ?></div>
...
if ($_SESSION['MM_UserGroup']==1) //admin
  {
?>
     <a href="mods-pedals-editproduct.php?pedalid=<?php echo $row_rstThePedal['pedalid']; ?>">Edit</a> - <a href="mods-pedals-deleteproduct.php?pedalid=<?php echo $row_rstThePedal['pedalid']; ?>">Delete</a>
<?php
  }
else
  {
?>
	<a href="mods-order.php?pedalid=<?php echo $row_rstThePedal['pedalid']; ?>">Order This Item</a>
<?php
  }
?>
	</div>
