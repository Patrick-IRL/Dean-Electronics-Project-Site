  ...
  <ul>
    ...
    <li><a href="mods-pedals-viewbystatus.php?status_id=5">Completed</a></li>
        ...
        <?php do { ?>
          <div id="adminlistview">
            <table width="748" border="1" cellspacing="3" cellpadding="3">
              <tr>
                ...
                <td><?php echo $row_rstpedalmodorder['id']; ?></td>
              </tr>
              <tr>
                <th scope="row">Date Submitted</th>
                <td><?php echo $row_rstpedalmodorder['datesubmitted']; ?></td>
              </tr>
              <tr>
                <th scope="row">Status</th>
                <td><?php echo $row_rstpedalmodorder['status']; ?></td>
              </tr>
              <tr>
                <th scope="row">First Name</th>
                <td><?php echo $row_rstpedalmodorder['fname']; ?></td>
              </tr>
              <tr>
                <th scope="row">Last Name</th>
                <td><?php echo $row_rstpedalmodorder['lname']; ?></td>
              </tr>
              <tr>
                <th scope="row">Email</th>
                <td><?php echo $row_rstpedalmodorder['email']; ?></td>
              </tr>
              <tr>
                <th scope="row">Phone</th>
                <td><?php echo $row_rstpedalmodorder['phone']; ?></td>
              </tr>
              <tr>
                <th scope="row">Pedal Brand</th>
                <td><?php echo $row_rstpedalmodorder['brandname']; ?></td>
              </tr>
              <tr>
                <th scope="row">Pedal Model</th>
                <td><?php echo $row_rstpedalmodorder['pedalmodelname']; ?></td>
              </tr>
              <tr>
                <th scope="row">Price</th>
                <td><?php echo $row_rstpedalmodorder['priceordered']; ?></td>
              </tr>
              <tr>
          ...
          <?php } while ($row_rstpedalmodorder = mysql_fetch_assoc($rstpedalmodorder)); ?>
  </div>
