...
$query_rstcustompedalslist = "SELECT tblcustompedals.id, tblcustompedals.cpname, tblcustompedals.cppic, tblcustompedals.cppicsmall, tblcustompedals.cpprice, tblcustompedals.cpdesc, tblcustompedals.cp_cat_id, tblcustompedals.cplongdesc, tblcustompedals.picalttag, otblcats.catid, otblcats.catname FROM otblcats INNER JOIN tblcustompedals ON otblcats.catid = tblcustompedals.cp_cat_id;";
$rstcustompedalslist = mysql_query($query_rstcustompedalslist, $deanelectro) or die(mysql_error());
$row_rstcustompedalslist = mysql_fetch_assoc($rstcustompedalslist);
$totalRows_rstcustompedalslist = mysql_num_rows($rstcustompedalslist);
  ...
  <div id="navbar">
    ...
    <div id="catlist">
      <ul>
        ...
        <?php do { ?>
        <div class="prodbox">
          <p><a href="custom-pedals-details.php?id=<?php echo $row_rstcustompedalslist['id']; ?>"><?php echo $row_rstcustompedalslist['cpname']; ?></a></p>
          <p><?php echo $row_rstcustompedalslist['catname']; ?></p>
          <p>€<?php echo $row_rstcustompedalslist['cpprice']; ?></p>
          <p><a href="custom-pedals-details.php?id=<?php echo $row_rstcustompedalslist['id']; ?>"><img src="<?php echo $row_rstcustompedalslist['cppicsmall']; ?>" alt="<?php echo $row_rstcustompedalslist['picalttag']; ?>" /></a></p>
...
if ($_SESSION['MM_UserGroup']==1) //admin
  {
?>
              <a href="custom-pedals-editproduct.php?id=<?php echo $row_rstcustompedalslist['id']; ?>">Edit</a> - <a href="custom-pedals-deleteproduct.php?id=<?php echo $row_rstcustompedalslist['id']; ?>">Delete</a>
<?php
  }
else
  {
...
<!-- PHP If Statements End-->
          ...
          <?php } while ($row_rstcustompedalslist = mysql_fetch_assoc($rstcustompedalslist)); ?>
   </div>
...
<?php
mysql_free_result($rstcustompedalslist);
