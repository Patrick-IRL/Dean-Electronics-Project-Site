...
$query_rstcamporderview = "SELECT p.*, b.`status`, c.* FROM `tblcustomamporders` AS p JOIN `otblservstatus` AS b     ON p.`caorderstatus_id` = b.`status_id` JOIN `otblwattage` AS c     ON p.`watt_id` = c.`wattid` ORDER BY datesubmitted DESC";
$rstcamporderview = mysql_query($query_rstcamporderview, $deanelectro) or die(mysql_error());
$row_rstcamporderview = mysql_fetch_assoc($rstcamporderview);
$totalRows_rstcamporderview = mysql_num_rows($rstcamporderview);
?>
        ...
        <div id="adminlistview">
          <table width="748" border="1" cellspacing="3" cellpadding="3">
            <tr>
              ...
              <td><?php echo $row_rstcamporderview['id']; ?></td>
            </tr>
            <tr>
              <th scope="row">Date Submitted</th>
              <td><?php echo $row_rstcamporderview['datesubmitted']; ?></td>
            </tr>
            <tr>
              <th scope="row">Status</th>
              <td><?php echo $row_rstcamporderview['status']; ?></td>
            </tr>
            <tr>
              <th scope="row">First Name</th>
              <td><?php echo $row_rstcamporderview['fname']; ?></td>
            </tr>
            <tr>
              <th scope="row">Last Name</th>
              <td><?php echo $row_rstcamporderview['lname']; ?></td>
            </tr>
            <tr>
              <th scope="row">Email</th>
              <td><?php echo $row_rstcamporderview['email']; ?></td>
            </tr>
            <tr>
              <th scope="row">Phone</th>
              <td><?php echo $row_rstcamporderview['phone']; ?></td>
            </tr>
            <tr>
              <th scope="row">Custom Amp Model</th>
              <td><?php echo $row_rstcamporderview['campname']; ?></td>
            </tr>
            <tr>
              <th scope="row">Wattage</th>
              <td><?php echo $row_rstcamporderview['wattageband']; ?></td>
            </tr>
            <tr>
              <th scope="row">Price</th>
              <td><?php echo $row_rstcamporderview['camppriceordered']; ?></td>
            </tr>
            <tr>
              <th scope="row">Moderate</th>
              <td><a href="custom-amps-order-edit.php?id=<?php echo $row_rstcamporderview['id']; ?>">Edit</a> - <a href="custom-amps-order-delete.php?id=<?php echo $row_rstcamporderview['id']; ?>">Delete</a></td>
            </tr>
          </table>
        </div>
        <?php } while ($row_rstcamporderview = mysql_fetch_assoc($rstcamporderview)); ?>
  </div>
...
<?php
mysql_free_result($rstcamporderview);
?>
