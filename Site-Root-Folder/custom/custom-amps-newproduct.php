...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblcustomamps (id, caname, wattrange_id, wattage, capic, capicsmall, caprice, cadesc, capicalt, calongdesc) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_deanelectro, $deanelectro);
$query_rsteditcamp = "SELECT * FROM tblcustomamps";
...
<title>Dean Electronics - Custom Amplifiers - New Product</title>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="caname" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
...
do {  
?>
            <option value="<?php echo $row_rsteditampwatts['wattid']?>" ><?php echo $row_rsteditampwatts['wattageband']?></option>
            <?php
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="wattage" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Main Image URL:</td>
          <td><input type="text" name="capic" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Small Image URL:</td>
          <td><input type="text" name="capicsmall" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Price:</td>
          <td><input type="text" name="caprice" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Short Description:</td>
          <td><input type="text" name="cadesc" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Description of Images:</td>
          <td><input type="text" name="capicalt" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Long Description:</td>
          <td><textarea name="calongdesc" id="calongdesc" cols="45" rows="5"></textarea></td>
        </tr>
        <tr valign="baseline">
