...
$colname_rstmessagesbystatus = "-1";
if (isset($_GET['status_id'])) {
  $colname_rstmessagesbystatus = $_GET['status_id'];
}
mysql_select_db($database_deanelectro, $deanelectro);
$query_rstmessagesbystatus = sprintf("SELECT c.*, s.* FROM tblcontact AS c JOIN otblservstatus AS s ON c.statusid = s.status_id WHERE status_id = %s ORDER BY datesubmitted DESC", GetSQLValueString($colname_rstmessagesbystatus, "int"));
$rstmessagesbystatus = mysql_query($query_rstmessagesbystatus, $deanelectro) or die(mysql_error());
$row_rstmessagesbystatus = mysql_fetch_assoc($rstmessagesbystatus);
$totalRows_rstmessagesbystatus = mysql_num_rows($rstmessagesbystatus);
?>
...
<div id="wrapper" class="clearfix">
  ...
  <ul>
    ...
    <?php do { ?>
      <div id="adminlistview">
        <table width="746" border="1" cellspacing="3" cellpadding="3">
          <tr>
            ...
            <td><?php echo $row_rstmessagesbystatus['id']; ?></td>
          </tr>
          <tr>
            <th scope="row">Date Submitted</th>
            <td><?php echo $row_rstmessagesbystatus['datesubmitted']; ?></td>
          </tr>
          <tr>
            <th scope="row">Status</th>
            <td><?php echo $row_rstmessagesbystatus['status']; ?></td>
          </tr>
          <tr>
            <th scope="row">First Name</th>
            <td><?php echo $row_rstmessagesbystatus['fname']; ?></td>
          </tr>
          <tr>
            <th scope="row">Last Name</th>
            <td><?php echo $row_rstmessagesbystatus['lname']; ?></td>
          </tr>
          <tr>
            <th scope="row">Email</th>
            <td><?php echo $row_rstmessagesbystatus['email']; ?></td>
          </tr>
          <tr>
            <th scope="row">Phone</th>
            <td><?php echo $row_rstmessagesbystatus['phone']; ?></td>
          </tr>
          <tr>
            <th scope="row">Subject</th>
            <td><?php echo $row_rstmessagesbystatus['subject']; ?></td>
          </tr>
          <tr>
            <th scope="row">Message</th>
            <td><?php echo $row_rstmessagesbystatus['message']; ?></td>
          </tr>
          <tr>
      ...
      <?php } while ($row_rstmessagesbystatus = mysql_fetch_assoc($rstmessagesbystatus)); ?>
  </div>
...
<?php
mysql_free_result($rstmessagesbystatus);
?>
